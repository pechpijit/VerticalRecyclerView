...
import com.example.sourceandroid.verticalrecyclerview.models.TestModel;
        ...
        baseViewHolder.mViewContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (holder.getAdapterPosition() == 0) {
                    ...
                    mContext.startActivity(new Intent(mContext, MainActivityUpload.class));
                }else if (holder.getAdapterPosition() == 2) {
                    mContext.startActivity(new Intent(mContext, GallarySample.class));
